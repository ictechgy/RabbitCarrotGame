...
public class Carrot {
    ...
    public Carrot getInstance(Toolkit toolkit, int panelWidth, int panelHeight){
        ...
        random = new Random();
        INSTANCE.x = random.nextInt(panelWidth-IMG_CARROT.width)+IMG_CARROT.width/2;
        INSTANCE.y = random.nextInt(panelHeight-IMG_CARROT.height)+IMG_CARROT.height/2;      //랜덤위치에 생성
        return INSTANCE;
